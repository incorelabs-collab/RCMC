                                ...
                                if(val != null) {
                                    switch(index) {
                                        ...
                                        case "Blood_Group":
                                            ...
                                            break;
                                        case "Hobbies":
                                            kidsBodyString += "<div class='row kidsItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Hobbies</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-sunglasses Icon'></span></div></div>";
                                            break;
                                    }
                                }
                            });
                                                    ...
                                                    function(tx, r) {
                                                            ...
                                                            if(val != null) {
                                                                switch(index) {
                                                                    ...
                                                                    case "Name_of_Company":
                                                                        parentBodyString += "<div class='row listItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Name of Company</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-briefcase Icon'></span></div></div>";
                                                                        break;
                                                                    case "Designation":
                                                                    ...
                                                                    case "Office_phone":
                                                                        ...
                                                                        break;
                                                                    case "Food":
                                                                        parentBodyString += "<div class='row listItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Food</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-cutlery Icon'></span></div></div>";
                                                                        break;
                                                                    case "Hobbies":
                                                                        parentBodyString += "<div class='row listItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Hobbies</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-sunglasses Icon'></span></div></div>";
                                                                        break;
                                                                }
                                                        ...
                                                        $.each(commonData, function(index, val) {
                                                            if(val != null) {
                                                                switch(index) {
                                                                    case "Membership_No":
                                                                        parentBodyString += "<div class='row listItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Membership No</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-credit-card Icon'></span></div></div>";
                                                                        break;
                                                                    case "res_addr1":
